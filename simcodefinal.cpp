...
int main(){
	...
	time_max=10000; area=10000; consv=1-1/sqrt(area);rate=0.000;w=0.05;weakening=0.0;modulus=0.001;a=4.0;b=1.1985;//define parameters
b=1/tgamma(1+1/a);
	double *strs;
...
//			}
	...
	fp=fopen("C:\\c\\wblstressweak0p0w4p0area1e5.txt","w");//open the stress file, change this filename to whatever you want
	for (time=0;time<time_max;time++){ fprintf(fp,"%f\n",force[time]);}//write the force array

	fclose(fp);
	fp=fopen("C:\\c\\wblstrainweak0p0w4p0area1e5.txt","w");//open the stress file, change this filename to whatever you want
	fprintf(fp,"%f\n",strain[0]);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
This is a random number generator. It has been edited. DON'T TOUCH THIS. It is the blackest of boxes. I don't know how it works, you won't know how it works. Seriously, just leave it be.
 ...
 *
 * See the file COPYING for details. [yeah I don't have this - Alan]
 */
	double *ranmarin(int ijkl, int N)
	{
	double c,cd,cm,u[97];
